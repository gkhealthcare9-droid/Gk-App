      ...
      appBar: CustomAppBar(
        ...
        actions: [
          Padding(
            ...
            child: Center(
              child: Obx(() {
                final filteredCount = vendorController.vendors.where((v) {
                  ...
                  final matchesState = _selectedState.value.isEmpty ? true : (v.state?.toLowerCase() == _selectedState.value.toLowerCase());
                  final matchesCity = _selectedCity.value.isEmpty ? true : (v.city?.toLowerCase() == _selectedCity.value.toLowerCase());
        ...
        children: [
          ...
          Expanded(
            child: Obx(() {
              ...
              if (filtered.isEmpty) {
                return const Center(child: Text('No matching vendors'));
              }
