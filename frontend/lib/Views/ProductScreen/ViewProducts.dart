...
import 'EditProductScreen.dart'; // Import for PdfPageFormat
        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Category dropdown
                Obx(() {
                  // extract only non-null categories
                  final catsRaw =
          ...
          Expanded(
            child: Obx(() {
              ...
              final filtered =
                  _productController.products.where(_matchesSearch).toList();
              if (filtered.isEmpty) {
...
class ProductDetailScreen extends StatelessWidget {
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  ...
                  _deleteProduct(context); // Proceed to delete
                },
                child: const Text(
                  "Delete",
  ...
  void _deleteProduct(BuildContext context) async {
    // Call your delete logic from controller
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (updatedProduct != null && updatedProduct is GetProductModel) {
                // If the product was edited and returned, rebuild the screen with updated data.
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder:
                        (_) => ProductDetailScreen(product: updatedProduct),
                  ),
                );
              }
            },
  ...
  Widget _buildInfoCard() {
    return Stack(
      alignment: Alignment.topRight, // Aligns the delete button to top-right
      children: [
        Container(
          width: double.infinity,
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                '📈 Tax',
                product.tax != null ? '${product.tax}%' : null,
              ),
              const SizedBox(height: 32), // space to avoid overlap
            ],
          ),
        ),
        Positioned(
          ...
          child: IconButton(
            ...
            onPressed: () async {
              ...
              if (confirm == true) {
                final success = await Get.find<ProductController>()
  ...
  Future<void> _shareProduct(BuildContext context) async {
    try {
      ...
      // Use Roboto font to support Unicode characters like ₹
